...
- Gợi ý phím tắt thông minh qua which-key.nvim.
...
- Phím tắt mặc định:
  - Leader + ?: Hiện bảng hướng dẫn tra cứu tất cả phím tắt
  ...
  - Di chuyển giữa các cửa sổ (Split/Sidebar):
    - Ctrl + h, j, k, l: Di chuyển sang cửa sổ Trái, Dưới, Trên, Phải
    - Ctrl + Phím mũi tên: Di chuyển tương ứng
